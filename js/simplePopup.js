...
function sPopup(param){
	$(document).ready(function(){
		...
		$(".sPopup").click(function(){
			...
			// on affiche
			$('body').append('<div id="sPopup-container"><div style="width:'+param.width+'px;" id="sPopup-popup"><div style="clear:both;"></div>'+contenu+'</div></div>');
			...
			$("#sPopup-container").click(function(){
				$("#sPopup-container").fadeOut(param.fadeSpeed, function(){
					$(this).remove();
					//window.scrollTo(0, pos);
					$('body').css({ overflow : "auto" });
